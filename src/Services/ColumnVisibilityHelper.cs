...
namespace PantherShootoutScoreSheetGenerator.Services
{
	...
	/// </summary>
	public class ColumnVisibilityHelper : IColumnVisibilityHelper
	{
		/// <summary>
		...
		public IList<Request> CreateHideColumnsRequest(int? sheetId, int startColumnIndex, int endColumnIndex)
		{
			var requests = new List<Request>();

			// First, create a column group
			requests.Add(new Request
			{
				AddDimensionGroup = new AddDimensionGroupRequest
				{
