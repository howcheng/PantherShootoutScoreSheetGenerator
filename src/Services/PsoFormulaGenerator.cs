...
namespace PantherShootoutScoreSheetGenerator.Services
{
	public class PsoFormulaGenerator : FormulaGenerator
	{
		...
		/// <returns></returns>
		/// <remarks>=IFS(OR(ISBLANK(A3),P3=""),0,P3="H",6,P3="D",3,P3="A",0)+IFS(B3="",0,B3<=3,B3,B3>3,3)+IFS(C3="",0,C3=0,1,C3>0,0)
		...
		/// <param name="startRowNum"></param>
		/// <returns></returns>
		/// <remarks>=IFS(OR(ISBLANK(A3),P3=""),0,P3="A",6,P3="D",3,P3="H",0)+IFS(B3="",0,B3<=3,B3,B3>3,3)+IFS(C3="",0,C3=0,1,C3>0,0)
		...
		/// + if home goals not entered yet, 0; if 0 home goals, +1; anything else, 0
		/// </remarks>
		...
		/// <param name="opponentCell"></param>
		/// <returns></returns>
		/// <remarks>SWITCH(ArrayFormula(VLOOKUP(Shootout!A18&Shootout!A17,{D$3:D$12&A$3:A$12, P$3:P$12},2,false)), "H", "L", "A", "W", "D", "D")
		...
		/// <summary>
		/// Gets the formula for determining the rank, taking into account the tiebreaker checkbox
		/// </summary>
		/// <param name="startRowNum"></param>
		/// <param name="endRowNum"></param>
		/// <param name="calculatedRankColumnName"></param>
		/// <param name="tiebreakerColumnName"></param>
		/// <returns></returns>
		...
		/// </remarks>
		public string GetRankWithTiebreakerFormula(int startRowNum, int endRowNum, string calculatedRankColumnName, string tiebreakerColumnName)
		{
			string cellRange = Utilities.CreateCellRangeString(calculatedRankColumnName, startRowNum, endRowNum, CellRangeOptions.FixRow);
			string firstRankCell = $"{calculatedRankColumnName}{startRowNum}";
			string firstTiebreakerCell = $"{tiebreakerColumnName}{startRowNum}";
